...
public class GeneAnnotator_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("project.deiis.types.GeneAnnotator");
  ...
  public String getCasProcessorId(int addr) {
      ...
      jcas.throwFeatMissing("casProcessorId", "project.deiis.types.GeneAnnotator");
